...
CREATE TABLE IF NOT EXISTS `site`.`comments` (
    ...
    `date`                  DATETIME 	  NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'date and time of submission',
...
CREATE TABLE IF NOT EXISTS `site`.`reviews` (
    ...
    `date`                  DATETIME 	  NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'date and time of submission',
    `last_modified`         DATETIME 	  NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'date and time of last modification',
