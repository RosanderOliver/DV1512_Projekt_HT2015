...
define("SQL_SELECT_PROJECTS_WHERE_ID","SELECT * FROM `site`.`projects` WHERE `id`=:id");
define("SQL_UPDATE_USER_AS_FEASIBLE_REVIEWERS_WHERE_ID","UPDATE `site`.`projects` SET `feasible_reviewers`=:feasible_reviewers WHERE `id`=:id);
