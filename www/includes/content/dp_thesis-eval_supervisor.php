...
<table class="form_table">
  ...
  <tr>
    <td>Full name: </td>
    <td colspan="6"><input type="text" name="student1" value="" class="form_input" required></td> <!-- required -->
  </tr>
  <tr>
    <td>E-mail: </td>
    <td colspan="2"><input type="text" name="s1email" class="form_input" required></td> <!-- required -->
    <td >PNR:</td>
  ...
  <tr>
    <td>Full name: </td>
    <td colspan="6"><input type="text" name="student2" value="" class="form_input"></td>
  </tr>
  <tr>
    <td>E-mail:</td>
    <td colspan="2"><input type="text" name="s2email" class="form_input"></td>
    <td >PNR: </td>
  ...
  <tr>
    <td>Supervisor: </td>
    <td colspan="6"><input type="text" name="supervisor" class="form_input" required></td> <!-- required -->
  </tr>
  <tr>
    <td>Thesis type:</td>
    <!-- required -->
    <td colspan="3"><input type="text" name="thesistype" value="" class="form_input" required></td><td colspan="2"><i>Thesis types: Bachelor of Science, 15hp, Master of Science, 15 hp, Master of Science, 30hp, Master of Science of Engeneering (civilingenj&ouml;r)</i></td>
  </tr>
  ...
  <tr>
    ...
    <td><input type="text" name="s1" id="s1" value="" class="form_input" required></td>
  </tr>
  ...
  <tr>
    ...
    <td><input type="text" name="s2" id="s2" value="" class="form_input" required></td>
  </tr>
  ...
  <tr>
    ...
    <td><input type="text" name="s3" id="s3" value="" class="form_input" required></td>
  </tr>
  ...
  <tr>
    ...
    <td><input type="text" name="s4" id="s4" value="" class="form_input" required></td>
    <td><input type="text" name="s5" id="s5" value="" class="form_input" required></td>
  </tr>

  <tr>
    <td><b>Computded grade</b></td><td></td><td></td><td></td><td><input type="text" name="s6" id="s6" value="" class="form_input" required></td>
  </tr>
  <tr>
    <td><b>Overall impression</b></td><td></td><td></td><td></td><td><textarea name="impression" rows="1" class="form_input" required></textarea></td>
  </tr>

  <tr>
    <td>Reviewer</td>
    <td><input type="text" name="rname" class="form_input" required></td> <!-- required -->
    <td>Date</td>
  ...
  <tr>
    <td colspan="7"><textarea name="feedback" rows="20" value="" class="form_input" required></textarea></td> <!-- required -->
  </tr>
